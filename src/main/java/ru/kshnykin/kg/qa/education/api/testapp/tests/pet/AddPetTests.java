...
public class AddPetTests extends BaseTest {
    ...
    @Test
    @DisplayName("отпрвлен не заполненый объект -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены, кроме поля id -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены, кроме поля category -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены, кроме поля category.id -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены, кроме поля category.name -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены, кроме поля name -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены, кроме поля photoUrls -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены, кроме поля tags -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены, кроме поля status -> OK")
    ...
    @Test
    @DisplayName("заполнено только поле id -> OK")
    ...
    @Test
    @DisplayName("заполнено только поле category -> OK")
    ...
    @Test
    @DisplayName("заполнено только поле category.id -> OK")
    ...
    @Test
    @DisplayName("заполнено только поле category.name -> OK")
    ...
    @Test
    @DisplayName("заполнено только поле name -> OK")
    ...
    @Test
    @DisplayName("заполнено только поле photoUrls -> OK")
    ...
    @Test
    @DisplayName("заполнено только поле tags -> OK")
    ...
    @Test
    @DisplayName("заполнено только поле status -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены и поле id = радомное целое число -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле id = 0 -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и поле id = рандомное вещественно число -> ERROR")
    ...
    @Test
    @DisplayName("все поля заполнены и поле id = рандомное отрицптельное число -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены и поле id = true -> ERROR")
    ...
    @Test
    @DisplayName("все поля заполнены и поле id = '%' -> ERROR")
    ...
    @Test
    @DisplayName("все поля заполнены и поле id = 'пять' -> ERROR")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле category.id = радомное целое число -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле category.id = 0 -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле category.id = рандомное вещественно число -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле category.id = рандомное отрицптельное число -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле category.id = true -> ERROR")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле category.id = '%' -> ERROR")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле category.id = 'пять' -> ERROR")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле category.name = радомная строка 5 букв -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле category.name = рандомная строка 100 букв -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле category.name = '%' -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле category.name = '|!\"№;:?*()_+.,%' -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле category.name = true -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле category.name = радомное целое число -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле category.name = рандомное вещественно число -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле name = радомная строка 5 букв -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле name = рандомная строка 100 букв -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле name = '%' -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле name = '|!\"№;:?*()_+.,%' -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле name = true -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле name = радомное целое число -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле name = рандомное вещественно число -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле photoUrls = [радомная строка 5 букв] -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле photoUrls = [100 ссылок на картинки] -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле photoUrls = ['%'] -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле photoUrls = [радомное целое число] -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле photoUrls = [рандомное вещественно число] -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле photoUrls = [true] -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле tags = [1 валидный обект] -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле tags = [100 валидных обектов] -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле tags[0].id = радомное целое число -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле tags[0].id = 0 -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле tags[0].id = рандомное вещественно число -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле tags[0].id = рандомное отрицптельное число -> ERROR")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле tags[0].id = true -> ERROR")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле tags[0].id = '%' -> ERROR")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле tags[0].id = 'пять' -> ERROR")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле tags[0].name = радомная строка 5 букв -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле tags[0].name = рандомная строка 100 букв -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле tags[0].name = '%' -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле tags[0].name = '|!\"№;:?*()_+.,%' -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле tags[0].name = true -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле tags[0].name = радомное целое число -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле tags[0].name = рандомное вещественно число -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле status = 'available' -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле status = 'pending' -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле status = 'sold' -> ОК")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле status = радомная строка 5 букв -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле status = рандомная строка 100 букв -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле status = '%' -> OK")
    ...
    @Test
    @DisplayName("все поля заполнены и если поле status = '|!\"№;:?*()_+.,%' -> OK")
